...
<head>
<title><%=(String)request.getAttribute("info") %></title>
				...
				<tr>
					...
					<td valign="top">
						<table width="400" border="1" cellpadding="0" cellspacing="0" style="BORDER-RIGHT:#cccccc 1px solid;BORDER-TOP:#cccccc 1px solid;BORDER-LEFT:#cccccc 1px solid;BORDER-BOTTOM:#cccccc 1px solid;BORDER-COLLAPSE:collapse;BACKGROUND-COLOR:#ffffff">
							<tr height="30">
								<td colspan="2" align="center" background="image/main/l-bg5.jpg"><font color="#ffff66"><b>³É¹¦</b></font></td>
							</tr>
							<tr height="150">
								<td align="center"><%=(String)request.getAttribute("info") %></td>
								<%
