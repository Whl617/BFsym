											...
											<td bgcolor="#FFFFFF">
												...
												<a style="font-size: medium;"  href="user/showarticle.action?id=<s:property value='#art.id'/>&username=<s:property value='#art.username'/>"><s:property value="#art.title"/></a>
													...
													<div align='right' class='smalltxt' height='32px'>
														...
														<!-- 评论与点击数 -->
														|评论(<s:property value="#request.critiqueCounts[#i=#i+1]"/>)|点击(<s:property value="#art.hadread"/>)|作者:<s:property value="#art.username"/>
													</div> </font>
											</td>
										</tr>
									</s:iterator>
										<tr>
											<td align="center">
												<s:if test="#request.page.hasPrePage">
													<a href="showall.action?currentPage=1">首页</a>
													<a href="showall.action?currentPage=${page.currentPage -1 }">上一页</a>
												</s:if>
												<s:else>
													首页
													上一页
												...
												<s:if test="#request.page.hasNextPage">
													<a href="showall.action?currentPage=${page.currentPage + 1 }">下一页</a>
													<a href="showall.action?currentPage=${page.totalPage }">尾页</a>			
												</s:if>
												<s:else>
													下一页
													尾页
